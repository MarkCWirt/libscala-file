...
int main(int, char**) {
    ...
    */
    ...
    assert(loaded_scale.get_ratio(1) == calcualte_cents(76.04900));
    assert(loaded_scale.get_ratio(2) == calcualte_cents(193.15686));
    assert(loaded_scale.get_ratio(3) == calcualte_cents(310.26471));
    assert(loaded_scale.get_ratio(4) == 5.0/4.0);
    assert(loaded_scale.get_ratio(5) == calcualte_cents(503.42157));
    assert(loaded_scale.get_ratio(6) == calcualte_cents(579.47057));
    assert(loaded_scale.get_ratio(7) == calcualte_cents(696.57843));
    assert(loaded_scale.get_ratio(8) == 25.0/16.0);
    assert(loaded_scale.get_ratio(9) == calcualte_cents(889.73529));
    assert(loaded_scale.get_ratio(10) == calcualte_cents(1006.84314));
    assert(loaded_scale.get_ratio(11) == calcualte_cents(1082.892));
